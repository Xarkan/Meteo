...
-->
    ...
    <link rel="stylesheet" href="View/style/home/font-awesome-4.7.0/css/font-awesome.min.css">                <!-- Font Awesome -->
    <link rel="stylesheet" href="View/style/home/css/bootstrap.min.css">                                      <!-- Bootstrap style -->
    <link rel="stylesheet" href="View/style/home/css/tooplate-style.css">                                   <!-- Templatemo style -->
    ...
    <body>
        ...
        <div class="container-fluid">
                ...
                <nav class="navbar">
                    ...
                    <div class="collapse navbar-toggleable-sm text-xs-center tm-navbar" id="tmNavbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="login">Contacts</a>
                            </li>
                        </ul>
                    </div>
                </nav>
            ...
            <section class="tm-section tm-section-home tm-flex-center" id="home">                
                ...
                <div class="tm-hero">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="text-uppercase tm-hero-title">meteotopper</h1>
            ...
            <section class="tm-section tm-section-contact" id="contact">
                <div class="tm-page-content-width">
                    <div class="tm-bg-black-translucent text-xs-left tm-textbox tm-2-col-textbox-2 tm-textbox-padding tm-textbox-padding-contact tm-content-box  tm-content-box-right">
                        ...
                        <!-- contact form -->
                        <form action="home.tpl" method="post" class="tm-contact-form">
        ...
        <!-- load JS files -->
        <script src="View/style/home/js/jquery-1.11.3.min.js"></script>         <!-- jQuery (https://jquery.com/download/) -->
        <script src="https://www.atlasestateagents.co.uk/javascript/tether.min.js"></script> <!-- Tether for Bootstrap (http://stackoverflow.com/questions/34567939/how-to-fix-the-error-error-bootstrap-tooltips-require-tether-http-github-h) -->
        <script src="View/style/home/js/bootstrap.min.js"></script>             <!-- Bootstrap js (v4-alpha.getbootstrap.com/) -->
        <script src="View/style/home/js/jquery.singlePageNav.min.js"></script>  <!-- Single page nav (https://github.com/ChrisWojcik/single-page-nav) -->
